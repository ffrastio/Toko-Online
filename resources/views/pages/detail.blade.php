                ...
                <div class="row">
                    <div class="col-lg-8" data-aos="zoom-in">
                        <transition name="slide-fade" mode="out-in">
                            <img :src="photos[activePhoto].url" :key="photos[activePhoto].id" class="w-100 active-image"
                                alt="" />
                        </transition>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="col-lg-2">
                            @auth
                                <form action="{{ route('detail-add', $product->id) }}" method="post"
                                    ...
                                    @csrf
                                    <button type="submit" class="btn btn-success px-4 mb-3 btn-block">Add to Cart</button>
                                </form>
                            @else
                                <a href="{{ route('login') }}" class="btn btn-success px-4 mb-3 btn-block">Login</a>
                            @endauth
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <img src="/images/icon-testimonial-1.png" alt="" class="rounded-circle mr-3 ml-2" />
                                    ...
                                    <li class="media">
                                        <img src="/images/icon-testimonial-2.png" alt="" class="rounded-circle mr-3 ml-2" />
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img src="/images/icon-testimonial-3.png" alt="" class="rounded-circle mr-3 ml-2" />
                                        <div class="media-body">
